...
import {
  AlertCircle, ArrowUpRight, CalendarDays, Check, CheckCircle2, ChevronDown, ChevronRight, CircleHelp, ClipboardList, ListChecks, Trash2,
...
function TaskCard({ task: taskItem, subtasks = [], showChecklistOnCard = false, onOpen, onToggleSubtask, compact = false, onDrop }) {
...
function BoardView({ state, checklistVisibility, onOpen, onToggleSubtask, onMove, onCreate, filters, setFilters }) {
...
function TaskDrawerContent({ task: taskItem, state, showChecklistOnCard, onToggleChecklistOnCard, onClose, onSave, onDelete, onComment, onAttachment, onOpenQuote, onAddSubtask, onRequestDelete, deleteState, showDeletePrompt, onCancelDelete, onConfirmDelete }) {
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (active === "board") return <BoardView state={state} checklistVisibility={checklistVisibility} onOpen={openTask} onToggleSubtask={saveTask} onMove={moveTask} onCreate={() => setCreating(true)} filters={filters} setFilters={setFilters} />;
